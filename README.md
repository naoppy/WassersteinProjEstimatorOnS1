...
Parses raw text reports generated by experiments, computes the diagonal elements of the inverse Fisher Information Matrix (the Cramer-Rao Lower Bounds), and outputs a structured CSV.
* **Usage Example**:
  ```python
